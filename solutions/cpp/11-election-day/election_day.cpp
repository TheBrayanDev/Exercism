...
ElectionResult& determine_result(std::vector<ElectionResult>& final_count) {
    ElectionResult& winner = *std::max_element(final_count.begin(), final_count.end(), 
        [](const ElectionResult& a, const ElectionResult& b) { return a.votes < b.votes; }); // lambda comparision 
